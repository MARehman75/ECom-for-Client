                                ...
                                <div className="border-b border-gray-900/10 pb-12">
                                    ...
                                    <ul role="list">
                                        {addresses.map((address) => (
                                            <li key={address.email} className="flex justify-between gap-x-6 py-5 border-solid border-2 border-grey-300 px-5">
                                                <div className="flex min-w-0 gap-x-4">
                                                    ...
                                                    <div className="min-w-0 flex-auto">
                                                        ...
                                                        <p className="mt-1 truncate text-xs leading-5 text-gray-500">{address.zipcode}, {address.city}</p>
                                                    </div>
                                                </div>
